...
import com.lekimthanh.thegioididong.DTO.CategoryDTO;
...
public class CategoryAdminController {
    ...
    public ModelAndView saveOrUpdate(ModelMap model, @ModelAttribute("category") CategoryDTO dto,
        ...
        try {
            ...
            model.addAttribute("message", "Loại hàng được lưu");
        } catch (Exception e) {
    ...
    public ModelAndView delete(ModelMap model, @PathVariable("categoryId") Long categoryId) throws IOException {
        try {
            ...
            model.addAttribute("message", "Loại hàng hóa dược xóa");
        } catch (Exception e) {
            model.addAttribute("message", "Không thể chứa loại hàng có chứa sản phẩm !");
        }
